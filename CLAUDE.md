...
- **Next:** **post-V1 (continued)** — **3 priority tiers:**
  ...
  **TIER 3 — Data/ops:**
  ...
  - SSE streaming e2e (handle connection drops gracefully) — deferred
