...
## ADIM 48 (kabul borcu B-01) — kabul kriteri borç defteri, sınıf B parti 01 (doc 05 Trade Log backend yüzeyi)
...
## ADIM 49 — kabul borcu sınıf B, parti 02 (dış work object'in run provenance'ı, docs 03/04/05)
