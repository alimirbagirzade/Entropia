...
# ADIM 88 LANDED — `C4` / E5: worker'ın paylaşımlı saat dalı · sıradaki slice için kickoff
...
> **NUMARA: 87 atlandı.** Bu slice ADIM 87 yazıldı; **PR #797** (kabul borcu batch 13) o numarayı
> **ve `docs/ADIM87_LANDED_KICKOFF.md` dosya yolunu** aldı. Çakışan şey başlık değil dosya
> yoludur. #797 bu daldan önce inerse, rebase sırasında **ADIM87 kickoff'u da `historical`a
> demote edilmelidir** (numarayla aynı commit'te), yoksa iki `current` kalır.
...
DURUM (2026-08-19 ölçüldü — DOĞRULA, GÜVENME):
  ADIM zinciri … 84·85·86·87 · canlı kickoff = docs/ADIM88_LANDED_KICKOFF.md
  alembic head 0043_i08_registry_strategy_fks · SHARED_ALLOCATION_STATUS = future_dev
  C1 #735 · C2 #759 · C3 #777 · C4 (ADIM 88) HEPSİ MERGED.
...
OKUMA SIRASI: (1) docs/ADIM88_LANDED_KICKOFF.md (bu belge)
