...
Alembic: `backend/alembic/versions/` — **head = `0042_i08_registry_strategy_fks`** (42 migration, tek head; `0041_filtered_event_artifact` üzerine I-08 slice 1'de eklendi — **yeni tablo yok, yalnız 3 FK constraint**).
...
`0042_i08_registry_strategy_fks` üç "mantıksal bağ"ı DB'ye devretti:
