...
name: sast-rce
description: >-
  Entropia'da uzaktan kod çalıştırma taraması: exec/eval/subprocess ile çalıştırılan kullanıcı girdisi. package_validation.py'nin exec(compiled, namespace) yüzeyine ya da yeni bir kod-çalıştırma yoluna dokunurken kullan.---
