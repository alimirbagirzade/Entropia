...
description: >-
  Entropia'da eksik kimlik/rol kapısı taraması: kimliksiz ulaşılabilen uç, atlanmış Admin/Supervisor/Agent kontrolü. Yeni endpoint eklerken ya da rol kapısını değiştirirken kullan.---
