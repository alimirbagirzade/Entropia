...
name: sast-analysis
description: >-
  Entropia güvenlik taramasının ZORUNLU İLK ADIMI: mimariyi çıkarır ve öteki sast-* skill'lerinin dayandığı sast/architecture.md dosyasını yazar. Herhangi bir sast-* taramasından ÖNCE koş.---
