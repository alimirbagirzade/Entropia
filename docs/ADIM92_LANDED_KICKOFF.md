...
DURUM (2026-08-19 ölçüldü — DOĞRULA, GÜVENME):
  ADIM zinciri … 85·86·87·88·91·92 (89/90 BOŞ — 89 bu dala bırakıldı ama kullanılamadı,
    90'ı #802 talep ediyor) · canlı kickoff = docs/ADIM92_LANDED_KICKOFF.md
  NUMARA KURALI (bu slice'ın en pahalı dersi): canlı kickoff MERGE ANINDA ağaçtaki EN
    YÜKSEK numaralı ADIM<n>…KICKOFF.md olmalı — kapı dosya VARLIĞINA bakar, doc-status'a
    değil. Bir paralel oturumun sana BIRAKTIĞI numara güvenli DEĞİLDİR: daha yüksek bir
    numarayla senden önce inerse o numara kullanılamaz olur. İnmiş en yükseğe göre seç.
  Update-branch DÜĞMESİNİ KULLANMA — üretilmiş blokları ve tek-`current` değişmezini
    sessizce bayatlatır; bu dalda bir tam CI turuna mal oldu. Rebase et.
  alembic head 0043_i08_registry_strategy_fks · SHARED_ALLOCATION_STATUS = future_dev
  C1 #735 · C2 #759 · C3 #777 · C4 (ADIM 92) HEPSİ MERGED.
  C4'ün importer-görünürlüğü sorusu İMZALANDI: #801 (d4efac3) ☑ Seçenek A (#799);
    rakip #800 KAPATILDI. Kabul edilmiş honest boundary: worker'ın contained alt
    sisteme uzanımı importer guard'ına GÖRÜNMEZ (izinli modülün arkasından geçer).
...
OKUMA SIRASI: (1) docs/ADIM92_LANDED_KICKOFF.md (bu belge)
