...
> **HISTORICAL RECORD — bu belge GUNCEL GERCEK DEGILDIR.** Yazildigi andaki durumu
> kaydeder. Guncel otorite: `CLAUDE.md` §Current position + `docs/generated/repository_facts.md`.
> Canli kickoff: `docs/ADIM35_LANDED_KICKOFF.md`.
