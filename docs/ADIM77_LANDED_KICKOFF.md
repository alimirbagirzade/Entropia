...
# ADIM 77 LANDED — kabul borcu batch 09 (doc 03, backend) · sıradaki slice için kickoff
...
> **SIRA UYARISI — ZİNCİR ÜÇ SEVİYE DERİN.** #757 (ADIM 75) → #763 (ADIM 76) → bu (ADIM 77).
...
TABAN — ÖNCE ZİNCİRİ ÖLÇ
  Üç PR yığılı ve hiçbiri inmemiş olabilir: #757 (ADIM 75) -> #763 (ADIM 76) -> batch 09
  (ADIM 77). Her birinin state/merged durumunu API'den OKU.
...
YAPILACAK
  ...
  kanıtlamaz — testi düzelt, kontrolü tekrarla (ADIM 77 dersi).
