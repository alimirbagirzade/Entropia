...
## Next: post-V1 (continued) — TIER 2 (… + TS/TL twins + ESP registry mutations landed — `esp.py` COMPLETE; Workspace'te SON placeholder **outsource-signal** [doc 03 keşfi ŞART — backend'de ayrı router YOK] + TIER 3 remain)
