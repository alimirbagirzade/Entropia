...
description: >-
  Entropia'da iş-mantığı kusuru taraması: durum makinesi atlatma, yarış, tekrar oynatma, sınır ihlali. OCC token, Idempotency-Key, lifecycle/deletion_state ya da onay akışı değişirken kullan.---
