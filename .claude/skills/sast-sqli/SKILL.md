...
name: sast-sqli
description: >-
  Entropia'da SQL injection taraması: SQLAlchemy text() / execute() ile kurulan ham sorgu, string ile birleştirilen filtre. Repository ya da query katmanında ham SQL yazarken kullan.---
